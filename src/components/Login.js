...
class Login extends Component {
    ...
    handleFacebookLogin = (provider) => {
        base.authWithOAuthPopup(provider, this.props.authHandler); //returns as err,authdata callback
    }
                    ...
                    <div className="container text-center w-75 mt-3">
                        <form ref={ form => this.form = form} onSubmit={this.handleSubmit}>
                            <div className="form-group">
                                ...
                                <input type="email" ref={input => this.loginEmail = input} id="loginEmail" className="form-control" placeholder="Email address" required/>        
                            </div>
                            <div className="form-group">
                                <label htmlFor="inputPassword" className="sr-only">Password</label>
                                <input type="password" ref={input => this.loginPassword = input} id="loginPassword"  className="form-control" placeholder="Password" required />
                            </div>
                        ...
                        <div className="container-fluid">
                            <button className="btn btn-primary w-100" onClick={ () => this.handleFacebookLogin('facebook')}>
