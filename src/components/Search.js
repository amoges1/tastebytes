...
class Search extends Component {
    ...
    getPlaces = (e) => {
        ...
        const config = {
            ...
            params: { term, latitude, longitude } 
        };
    ...
    addPlace = (e, name, address) => {
        ...
        if(!this.props.user.restaurants) {
            base.push(`users/${this.props.user_id}/restaurants/`, {
                ...
                then(err){ err ? console.log(err) : alert(`${name} on ${address.join(' ')} is added to your list.`) }
            });
            return
        } 
        ...
        return (
            <div>
                <div className="container" style={{paddingTop: "20px", textAlign: "center"}} >
                    <div className="container border-bottom" data-aos="fade-up"  data-aos-duration="1200">
