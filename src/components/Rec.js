...
const Rec = ({user, rec, addRec, removeRec}) => {
            ...
            <div className="card-footer d-flex justify-content-center">
                <div className="btn-group d-flex">
                    <button type="button" className="btn btn-sm btn-success" 
                        onClick={ (e) => addRec(e, key)}>Add <i className="fas fa-plus-circle"></i>
                    </button>
                    ...
                    <button type="button" className="btn btn-sm btn-danger" onClick={ (e) => removeRec(e, key)}>
